...
class Laundry extends Database implements iLaundry {
	...
	public function new_laundry($customer, $priority, $weight,$advpay, $type)
	{
		$sql = "INSERT INTO laundry(customer_name, laun_priority, laun_weight, adv_pay, laun_type_id)
				VALUES(?,?,?,?,?);";
		return $this->insertRow($sql, [$customer, $priority, $weight ,$advpay , $type]);
	}//end new_laundry
